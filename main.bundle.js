...
var AppComponent = (function () {
    function AppComponent(router) {
        ...
        this.navOpen = false;
        console.log("Website Owner: Impact Dynamics Limited");
        console.log("Website Author: James Clare");
        console.log("Iteration: 1.0.11");
    ...
    AppComponent.prototype.openNav = function () {
        ...
        document.getElementById("menuIcon").style.color = "gray";
        this.navOpen = true;
    };
